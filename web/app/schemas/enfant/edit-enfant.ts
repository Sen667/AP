...
export const EditEnfantSchema = z.object({
    ...
    medecinTraitantTel: z.string().min(6, "Le téléphone du médecin est requis"),
});

export type EditEnfantData = z.infer<typeof EditEnfantSchema>;
